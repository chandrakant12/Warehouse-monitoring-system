...
<div class="container text-center">
	...
	<br>
	<div class="container">
		<form  class="card" method="post" action="" name="frmdoctprfl" onSubmit="return validateform()">
			<br>
			<h4 class="card-header white-text purple-gradient rounded">Add new Staff record</h4>
			<br>
