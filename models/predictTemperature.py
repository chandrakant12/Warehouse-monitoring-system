...
tsModel = joblib.load('/opt/lampp/htdocs/gitlab/warehouse-data-logging-website-sih/models/temperatureModel.pkl') 
# Use the loaded model to make predictions 
predictions = tsModel.predict(str(currentTime))#,str(nextTime))
print(predictions)
