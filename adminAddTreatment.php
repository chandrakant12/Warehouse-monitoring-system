		...
		<div id="container">
			...
			<form method="post" action="" name="frmtreat" onSubmit="return validateform()">
				<table class="table">
					<tbody>
						<tr>
							<td width="40%">Treatment Type</td>
							<td width="60%"><input type="text" name="treatmenttype" id="treatmenttype"  value="<?php echo $rsedit[treatmenttype]; ?>"/></td>
						</tr>
						
						<tr>
							<td width="40%">Treatment Cost</td>
							<td width="60%"><input type="text" name="treatmentcost" id="treatmentcost"  value="<?php echo $rsedit[treatment_cost]; ?>"/></td>
						</tr>
						<tr>
							<td>Note</td>
						...
						<tr>
							<td colspan="2" align="center"><input class="btn purple-gradient" type="submit" name="submit" id="submit" value="Submit" /></td>
						</tr>
