...
<?php
	...
	if(isset($_POST[submit])){
		...
		else
		{
			$dt = date("Y-m-d");
			$tim = date("H:i:s");
			$sql ="INSERT INTO user(patientname,admissiondate,admissiontime,address,city,mobileno,loginid,password,gender,dob,status) values('$_POST[patiente]','$dt','$tim','$_POST[textarea]','$_POST[city]','$_POST[mobileno]','$_POST[loginid]','$_POST[password]','$_POST[select6]','$_POST[dob]','Pending')";
		...
		<form method="post" action="" name="frmpatapp" class="text-center" style="color: #757575;" onSubmit="return validateform()">
			...
			<table width="100%" >
				<tbody class="form-group">
					<tr>
						<td >User Name : </td>
						<td ><input class="form-control" type="text" name="patiente" id="patiente" value="<?php echo $rspatient[patientname];  ?>"  <?php echo $readonly; ?> ></td>
					</tr>
					<tr>
						<td height="62">Address : </td>
						<td><textarea class="form-control" name="textarea" id="textarea" <?php echo $readonly; ?> > <?php echo $rspatient[address]; ?></textarea></td>
					</tr>
					<tr>
						<td>City</td>
						<td><input class="form-control" type="text" name="city" id="city" value="<?php echo $rspatient[city]; ?>" <?php echo $readonly; ?> ></td>
					</tr>
					<tr>
						<td>Mobile Number : </td>
						<td><input class="form-control" type="text" name="mobileno" id="mobileno" value="<?php echo $rspatient[mobileno];  ?>" <?php echo $readonly; ?> ></td>
					</tr>
					...
					<tr>
						<td>Login-ID : </td>
						<td><input class="form-control" type="text" name="loginid" id="loginid" value="<?php echo $rspatient[loginid];  ?>" <?php echo $readonly; ?> ></td>
					</tr>
					<tr>
						<td>Password : </td>
						<td><input class="form-control" type="password" name="password" id="password" value="<?php echo $rspatient[patientname];  ?>" <?php echo $readonly; ?> ></td>
					</tr>
					...
					<tr>
						<td>DOB</td>
						<td><input class="form-control" type="date" name="dob" id="dob" value="<?php echo $rspatient[dob]; ?>" <?php echo $readonly; ?> ></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<select class="browser-default custom-select" name="department" id="department" onchange="loaddoctor(this.value)">
