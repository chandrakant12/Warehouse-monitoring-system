...
<div class="container text-center">
	<br>
	<h3>View and Update Administrator Profile</h3>
	<br>
	<div class="container">
		<form class="md-form" method="post" action="" name="frmadminprofile" onSubmit="return validateform()">
			<table class="table">
				<tbody>
					<tr>
						<td width="40%">Admin Name</td>
						<td width="60%"><input type="text" name="adminname" id="adminname" value="<?php echo $rsedit[adminname]; ?>"/></td>
					</tr>
					<tr>
						<td>Login ID</td>
