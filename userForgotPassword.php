...
<div class="container">
	...
	<br>
	<div class="container">
		<h4>Kindly enter login detail to recover password..</h4>
		<form method="post" action="" name="frmpatlogin" onSubmit="return validateform()">
			<table class="table" width="200" border="3">
				<tbody>
					...
					<tr>
						<td height="36" colspan="2" align="center"><input type="submit" class="btn purple-gradient" name="submit" id="submit" value="Recover Password" /></td>
					</tr>
				</tbody>
			</table>
		</form>
