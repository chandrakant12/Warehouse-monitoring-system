...
<div class="container text-center">
	...
	<div class="wrapper col4">
		<div id="container">
			<form class="form-group" method="post" action="" name="frmpatprfl" onSubmit="return validateform()">
				<table class="table table-striped" width="100%" >
					<tbody >
						...
						<tr>
							...
							<td><input class="form-control" type="date" name="admissiondate" id="admissiondate" value="<?php echo $rsedit[admissiondate]; ?>" /></td>
						</tr>
						<tr>
							<td>Admission Time</td>
							<td><input class="form-control"  type="time" name="admissiontme" id="admissiontme" value="<?php echo $rsedit[admissiontime]; ?>" /></td>
						</tr>
						<tr>
							<td>Address</td>
							<td><textarea class="form-control"  name="address" id="address" cols="45" rows="3"> <?php echo $rsedit[address]; ?></textarea></td>
						</tr>
						<tr>
							<td>Mobile Number</td>
						...
						<tr>
							<td>Date Of Birth</td>
							<td><input class="form-control"  type="date" name="dateofbirth" id="dateofbirth"  value="<?php echo $rsedit[dob]; ?>"/></td>
						</tr>
						<tr>
							<td colspan="2" align="center"><input type="submit" name="submit" class="btn purple-gradient" id="submit" value="Submit" /></td>
						</tr>
					</tbody>
				</table>
			</form>
