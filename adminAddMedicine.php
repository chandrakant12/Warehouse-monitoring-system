			...
			<table class="table">
				<tbody>
					<tr>
						...
						<td width="60%"><input type="text" name="medicinename" id="medicinename" value="<?php echo $rsedit[medicinename]; ?>" /></td>
					</tr>
					<tr>
						<td width="40%">Medicine cost</td>
						<td width="60%"><input type="text" name="medicinecost" id="medicinecost" value="<?php echo $rsedit[medicinecost]; ?>" /></td>
					</tr>
					<tr>
						<td>Description</td>
